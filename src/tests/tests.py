...
class Test:
    ...
    def test_vacations_facade_get_all_vacations(self):
        try:
            ...
            vacations = self.vacations_facade.get_all_vacations()
            print("---")
    ...
    def test_vacations_facade_add_new_vacation(self):
        try:
            ...
            result = self.vacations_facade.add_new_vacation(
                country_id= 3,
                description= "Visit the Big Ben",
                start_date= "2024-06-01",
                end_date= "2024-08-31",
                price= 2000,
                vacation_photo_filename="big_ben_trip.jpg"
            )
            ...
            try:
                ...
                result_two = self.vacations_facade.add_new_vacation(
                    country_id= 2,
            ...
            try:
                ...
                result_three = self.vacations_facade.add_new_vacation(
                    country_id= 2,
                    description= "Summer in the USA",
                    start_date= "2024-06-01",
                    end_date= "2024-08-31",
            ...
            try:
                ...
                result_four = self.vacations_facade.add_new_vacation(
                    country_id= 2,
                    description= "Summer in the USA",
            ...
            try:
                ...
                result_five = self.vacations_facade.add_new_vacation(
                    country_id= 2,
                    description= "Summer in the USA",
    ...
    def test_vacations_facade_update_vacation(self):
        try:
            ...
            try:
                ...
                result = self.vacations_facade.update_vacation(
                    vacation_id=19,
                    country_id=11,
                    description="summer in amazing Philippines",
            ...
            try:
                ...
                result_two = self.vacations_facade.update_vacation(
                    vacation_id=1,
                    country_id=10,
                    description="Summer in the amazing great Canada",
                    start_date="2024-02-11",
                    end_date="2024-02-25",
                    price=1000,
            ...
            try:
                # test 3 - price outside 0-10k range
                result_three = self.vacations_facade.update_vacation(
                    vacation_id=1,
                    country_id=1,
            ...
            try:
                ...
                result_four = self.vacations_facade.update_vacation(
                    vacation_id=19,
                    country_id=11,
                    description="Trip across the Western Wall in Jerusalem and more",
            ...
            try:
                ...
                result_five = self.vacations_facade.update_vacation(
                    vacation_id=18,
                    country_id=1,
                    description="Trip across the streets of Haifa and beyond",
    ...
    def test_vacations_facade_delete_vacation(self):
        try:
            ...
            try:
                ...
                result = self.vacations_facade.delete_vacation(vacation_id=20)
            ...
            try:
                ...
                result_two = self.vacations_facade.delete_vacation(vacation_id=15)
    ...
    def test_users_facade_sign_new_user(self):
        try:
            ...
            try:
                ...
                result = self.users_facade.sign_new_user(
                    first_name="Second_Test",
                    last_name="User",
            ...
            try:
                ...
                result_two = self.users_facade.sign_new_user(
                    first_name="Ugi",
                    last_name="Fletzet",
            ...
            try:
                ...
                result_three = self.users_facade.sign_new_user(
                    first_name="Bart",
            ...
            try:
                ...
                result_four = self.users_facade.sign_new_user(
                    first_name="Bart",
                    last_name="Simpson",
            ...
            try:
                ...
                result_five = self.users_facade.sign_new_user(
                    first_name="Bart",
                    last_name="Simpson",
    ...
    def test_users_facade_sign_in(self):
        try:
            ...
            try:
                ...
                result = self.users_facade.sign_in(
            ...
            try:
                ...
                result_two = self.users_facade.sign_in(
                    email="ugi@example.com",
                )
            ...
            try:
                ...
                result_three = self.users_facade.sign_in(
            ...
            try:
                ...
                result_four = self.users_facade.sign_in(
                    email="ugi@example.com",
                    password="pas"
                )
    ...
    def test_likes_facade_add_like_to_vacation(self):
        try:
            ...
            try:
                ...
                result = self.likes_facade.add_like_to_vacation(user_id=1, vacation_id=19)
            ...
            try:
                ...
                result_two = self.likes_facade.add_like_to_vacation(user_id=10, vacation_id=1)
            ...
            try:
                # test 3 - one attr wasn't specified
                result_three = self.likes_facade.add_like_to_vacation(vacation_id=1)
                print(f"{Fore.GREEN} test 3 [attr wasn't specified]:{Style.RESET_ALL} {result_three}")
            except Exception as err:
                print(f"{Fore.GREEN} test 3 [attr wasn't specified]:{Style.RESET_ALL} {str(err)}")
    ...
    def test_likes_facade_unlike_vacation(self):
        try:
            ...
            try:
                ...
                result = self.likes_facade.unlike_vacation(user_id=1, vacation_id=7)
            ...
            try:
                ...
                result_two = self.likes_facade.unlike_vacation(user_id=5, vacation_id=5)
